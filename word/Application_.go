...
func (this *Application_) Browser() *Browser {
	...
	return NewBrowser(retVal.PdispValVal(), false, true)
}
...
func (this *Application_) MailingLabel() *MailingLabel {
	...
	return NewMailingLabel(retVal.PdispValVal(), false, true)
}
...
func (this *Application_) International(index int32) ole.Variant {
	retVal := this.PropGet(0x0000002e, []interface{}{index})
...
func (this *Application_) SetCustomizationContext(rhs *ole.DispatchClass)  {
...
func (this *Application_) BackgroundSavingStatus() int32 {
	retVal := this.PropGet(0x00000055, nil)
	return retVal.LValVal()
}
...
func (this *Application_) SetTop(rhs int32)  {
	retVal := this.PropPut(0x00000058, []interface{}{rhs})
	_= retVal
}
...
func (this *Application_) SetWidth(rhs int32)  {
	retVal := this.PropPut(0x00000059, []interface{}{rhs})
	_= retVal
}
...
func (this *Application_) SetHeight(rhs int32)  {
	retVal := this.PropPut(0x0000005a, []interface{}{rhs})
	_= retVal
}
...
func (this *Application_) SetWindowState(rhs int32)  {
	retVal := this.PropPut(0x0000005b, []interface{}{rhs})
	_= retVal
}
...
func (this *Application_) SetDisplayAlerts(rhs int32)  {
	retVal := this.PropPut(0x0000005e, []interface{}{rhs})
	_= retVal
}
...
func (this *Application_) IsObjectValid(object *ole.DispatchClass) bool {
...
func (this *Application_) MailMessage() *MailMessage {
	...
	return NewMailMessage(retVal.PdispValVal(), false, true)
}
...
func (this *Application_) PrintOutOld(optArgs ...interface{})  {
	...
	retVal := this.Call(0x0000012e, nil, optArgs...)
	_= retVal
}

func (this *Application_) LookupNameProperties(name string)  {
	retVal := this.Call(0x0000012f, []interface{}{name})
	_= retVal
}

func (this *Application_) SubstituteFont(unavailableFont string, substituteFont string)  {
	retVal := this.Call(0x00000130, []interface{}{unavailableFont, substituteFont})
	_= retVal
}
...
func (this *Application_) GetAddress(optArgs ...interface{}) string {
	...
	retVal := this.Call(0x00000142, nil, optArgs...)
	return win32.BstrToStrAndFree(retVal.BstrValVal())
}

func (this *Application_) CheckGrammar(string string) bool {
	retVal := this.Call(0x00000143, []interface{}{string})
	return retVal.BoolValVal() != win32.VARIANT_FALSE
}
...
func (this *Application_) AutomaticChange()  {
	retVal := this.Call(0x0000014a, nil)
	_= retVal
}

func (this *Application_) ShowMe()  {
	retVal := this.Call(0x0000014b, nil)
	_= retVal
}

func (this *Application_) HelpTool()  {
	retVal := this.Call(0x0000014c, nil)
	_= retVal
}
...
func (this *Application_) ListCommands(listAllCommands bool)  {
	retVal := this.Call(0x0000015a, []interface{}{listAllCommands})
	_= retVal
}
...
func (this *Application_) OnTime(when *ole.Variant, name string, optArgs ...interface{})  {
	...
	retVal := this.Call(0x0000015e, []interface{}{when, name}, optArgs...)
	_= retVal
}
...
func (this *Application_) MountVolume(zone string, server string, volume string, optArgs ...interface{}) int16 {
	...
	retVal := this.Call(0x00000161, []interface{}{zone, server, volume}, optArgs...)
...
func (this *Application_) ChangeFileOpenDirectory(path string)  {
	retVal := this.Call(0x00000165, []interface{}{path})
	_= retVal
}

func (this *Application_) RunOld(macroName string)  {
	retVal := this.Call(0x00000166, []interface{}{macroName})
	_= retVal
}

func (this *Application_) GoForward()  {
	retVal := this.Call(0x00000167, nil)
	_= retVal
}

func (this *Application_) Move(left int32, top int32)  {
	retVal := this.Call(0x00000168, []interface{}{left, top})
	_= retVal
}

func (this *Application_) Resize(width int32, height int32)  {
	retVal := this.Call(0x00000169, []interface{}{width, height})
	_= retVal
}
...
func (this *Application_) Activate()  {
	retVal := this.Call(0x00000181, nil)
	_= retVal
}
...
func (this *Application_) PointsToPixels(points float32, optArgs ...interface{}) float32 {
	...
	retVal := this.Call(0x00000183, []interface{}{points}, optArgs...)
	return retVal.FltValVal()
}
...
func (this *Application_) PixelsToPoints(pixels float32, optArgs ...interface{}) float32 {
	...
	retVal := this.Call(0x00000184, []interface{}{pixels}, optArgs...)
	return retVal.FltValVal()
}

func (this *Application_) KeyboardLatin()  {
	retVal := this.Call(0x00000190, nil)
	_= retVal
}

func (this *Application_) KeyboardBidi()  {
	retVal := this.Call(0x00000191, nil)
	_= retVal
}

func (this *Application_) ToggleKeyboard()  {
	retVal := this.Call(0x00000192, nil)
	_= retVal
}

func (this *Application_) Keyboard(langId int32) int32 {
	retVal := this.Call(0x000001be, []interface{}{langId})
	return retVal.LValVal()
}

func (this *Application_) ProductCode() string {
	retVal := this.Call(0x00000194, nil)
	return win32.BstrToStrAndFree(retVal.BstrValVal())
}

func (this *Application_) DefaultWebOptions() *DefaultWebOptions {
	retVal := this.Call(0x00000195, nil)
...
func (this *Application_) Run(macroName string, optArgs ...interface{}) ole.Variant {
	...
	retVal := this.Call(0x000001bd, []interface{}{macroName}, optArgs...)
	com.CurrentScope.AddVarIfNeeded((*win32.VARIANT)(retVal))
	return *retVal
}
...
func (this *Application_) PrintOut(optArgs ...interface{})  {
	...
	retVal := this.Call(0x000001c0, nil, optArgs...)
	_= retVal
}
...
func (this *Application_) FileDialog(fileDialogType int32) *ole.DispatchClass {
	retVal := this.PropGet(0x000001c2, []interface{}{fileDialogType})
	return ole.NewDispatchClass(retVal.PdispValVal(), true)
}
...
func (this *Application_) TaskPanes() *TaskPanes {
	...
	return NewTaskPanes(retVal.PdispValVal(), false, true)
}
...
func (this *Application_) Dummy2() bool {
	retVal := this.Call(0x000001ca, nil)
	return retVal.BoolValVal() != win32.VARIANT_FALSE
}
...
func (this *Application_) SmartTagTypes() *SmartTagTypes {
	...
	return NewSmartTagTypes(retVal.PdispValVal(), false, true)
}
...
func (this *Application_) PutFocusInMailHeader()  {
	retVal := this.Call(0x000001d0, nil)
	_= retVal
}
...
func (this *Application_) LoadMasterList(fileName string)  {
	retVal := this.Call(0x000001d5, []interface{}{fileName})
	_= retVal
}

func (this *Application_) CompareDocuments(originalDocument *Document, revisedDocument *Document, destination int32, granularity int32, compareFormatting bool, compareCaseChanges bool, compareWhitespace bool, compareTables bool, compareHeaders bool, compareFootnotes bool, compareTextboxes bool, compareFields bool, compareComments bool, compareMoves bool, revisedAuthor string, ignoreAllComparisonWarnings bool) *Document {
	retVal := this.Call(0x000001d6, []interface{}{originalDocument, revisedDocument, destination, granularity, compareFormatting, compareCaseChanges, compareWhitespace, compareTables, compareHeaders, compareFootnotes, compareTextboxes, compareFields, compareComments, compareMoves, revisedAuthor, ignoreAllComparisonWarnings})
	return NewDocument(retVal.PdispValVal(), false, true)
}

func (this *Application_) MergeDocuments(originalDocument *Document, revisedDocument *Document, destination int32, granularity int32, compareFormatting bool, compareCaseChanges bool, compareWhitespace bool, compareTables bool, compareHeaders bool, compareFootnotes bool, compareTextboxes bool, compareFields bool, compareComments bool, compareMoves bool, originalAuthor string, revisedAuthor string, formatFrom int32) *Document {
	retVal := this.Call(0x000001d7, []interface{}{originalDocument, revisedDocument, destination, granularity, compareFormatting, compareCaseChanges, compareWhitespace, compareTables, compareHeaders, compareFootnotes, compareTextboxes, compareFields, compareComments, compareMoves, originalAuthor, revisedAuthor, formatFrom})
	return NewDocument(retVal.PdispValVal(), false, true)
}
...
func (this *Application_) OMathAutoCorrect() *OMathAutoCorrect {
	...
	return NewOMathAutoCorrect(retVal.PdispValVal(), false, true)
}
...
func (this *Application_) ThreeWayMerge(localDocument *Document, serverDocument *Document, baseDocument *Document, favorSource bool)  {
	retVal := this.Call(0x000001e4, []interface{}{localDocument, serverDocument, baseDocument, favorSource})
	_= retVal
}

func (this *Application_) Dummy4()  {
	retVal := this.Call(0x000001e5, nil)
	_= retVal
}

func (this *Application_) UndoRecord() *UndoRecord {
	retVal := this.PropGet(0x000001e6, nil)
	return NewUndoRecord(retVal.PdispValVal(), false, true)
}
