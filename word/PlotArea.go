...
func PlotAreaFromVar(v ole.Variant) *PlotArea {
	return NewPlotArea(v.PdispValVal(), false, false)
}
...
func (this *PlotArea) InsideLeft() float64 {
	retVal := this.PropGet(0x00000683, nil)
	return retVal.DblValVal()
}

func (this *PlotArea) SetInsideLeft(rhs float64)  {
	retVal := this.PropPut(0x00000683, []interface{}{rhs})
	_= retVal
}

func (this *PlotArea) InsideTop() float64 {
	retVal := this.PropGet(0x00000684, nil)
	return retVal.DblValVal()
}

func (this *PlotArea) SetInsideTop(rhs float64)  {
	retVal := this.PropPut(0x00000684, []interface{}{rhs})
	_= retVal
}

func (this *PlotArea) InsideWidth() float64 {
	retVal := this.PropGet(0x00000685, nil)
	return retVal.DblValVal()
}

func (this *PlotArea) SetInsideWidth(rhs float64)  {
	retVal := this.PropPut(0x00000685, []interface{}{rhs})
	_= retVal
}

func (this *PlotArea) InsideHeight() float64 {
	retVal := this.PropGet(0x00000686, nil)
	return retVal.DblValVal()
}

func (this *PlotArea) SetInsideHeight(rhs float64)  {
	retVal := this.PropPut(0x00000686, []interface{}{rhs})
	_= retVal
}
