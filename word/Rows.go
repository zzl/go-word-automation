...
func RowsFromVar(v ole.Variant) *Rows {
	return NewRows(v.PdispValVal(), false, false)
}
...
func (this *Rows) Add(optArgs ...interface{}) *Row {
	...
	retVal := this.Call(0x00000064, nil, optArgs...)
	return NewRow(retVal.PdispValVal(), false, true)
}
...
func (this *Rows) SetLeftIndent_(leftIndent float32, rulerStyle int32)  {
	retVal := this.Call(0x000000ca, []interface{}{leftIndent, rulerStyle})
	_= retVal
}
...
func (this *Rows) ConvertToText(optArgs ...interface{}) *Range {
	...
	retVal := this.Call(0x000000d2, nil, optArgs...)
	return NewRange(retVal.PdispValVal(), false, true)
}
