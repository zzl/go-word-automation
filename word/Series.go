...
var IID_Series = syscall.GUID{0x40810760, 0x068A, 0x4486, 
	[8]byte{0xBE, 0xC9, 0x8E, 0xA5, 0x8C, 0x70, 0x29, 0xF5}}
...
func (this *Series) Border() *ChartBorder {
...
func (this *Series) PictureUnit() float64 {
	retVal, _ := this.PropGet(0x000000a2, nil)
	return retVal.DblValVal()
}

func (this *Series) SetPictureUnit(rhs float64)  {
...
func (this *Series) Format() *ChartFormat {
	retVal, _ := this.PropGet(0x60020052, nil)
	return NewChartFormat(retVal.IDispatch(), false, true)
}

func (this *Series) Application() *ole.DispatchClass {
...
func (this *Series) PlotColorIndex() int32 {
	retVal, _ := this.PropGet(0x00000784, nil)
	return retVal.LValVal()
}
