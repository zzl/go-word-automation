...
var IID_ApplicationEvents = syscall.GUID{0x000209F7, 0x0000, 0x0000, 
	[8]byte{0xC0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x46}}

type ApplicationEventsDispInterface interface {
...
type ApplicationEventsHandlers struct {
...
type ApplicationEventsDispImpl struct {
	Handlers ApplicationEventsHandlers
}

func (this *ApplicationEventsDispImpl) QueryInterface_(riid *syscall.GUID, ppvObj unsafe.Pointer) {
	if this.Handlers.QueryInterface_ != nil {
		this.Handlers.QueryInterface_(riid, ppvObj)
	}
}

func (this *ApplicationEventsDispImpl) AddRef_() uint32 {
...
func (this *ApplicationEventsDispImpl) Release_() uint32 {
...
func (this *ApplicationEventsDispImpl) GetTypeInfoCount_(pctinfo *uint32) {
	if this.Handlers.GetTypeInfoCount_ != nil {
		this.Handlers.GetTypeInfoCount_(pctinfo)
	}
}

func (this *ApplicationEventsDispImpl) GetTypeInfo_(itinfo uint32, lcid uint32, pptinfo unsafe.Pointer) {
	if this.Handlers.GetTypeInfo_ != nil {
		this.Handlers.GetTypeInfo_(itinfo, lcid, pptinfo)
	}
}

func (this *ApplicationEventsDispImpl) GetIDsOfNames_(riid *syscall.GUID, rgszNames **int8, cNames uint32, lcid uint32, rgdispid *int32) {
	if this.Handlers.GetIDsOfNames_ != nil {
		this.Handlers.GetIDsOfNames_(riid, rgszNames, cNames, lcid, rgdispid)
	}
}

func (this *ApplicationEventsDispImpl) Invoke_(dispidMember int32, riid *syscall.GUID, lcid uint32, wFlags uint16, pdispparams *win32.DISPPARAMS, pvarResult *ole.Variant, pexcepinfo *win32.EXCEPINFO, puArgErr *uint32) {
...
func (this *ApplicationEventsDispImpl) Startup() {
	if this.Handlers.Startup != nil {
		this.Handlers.Startup()
	}
}

func (this *ApplicationEventsDispImpl) Quit() {
	if this.Handlers.Quit != nil {
		this.Handlers.Quit()
	}
}

func (this *ApplicationEventsDispImpl) DocumentChange() {
	if this.Handlers.DocumentChange != nil {
		this.Handlers.DocumentChange()
	}
}

type ApplicationEventsImpl struct {
	ole.IDispatchImpl
	DispImpl ApplicationEventsDispInterface
}

func (this *ApplicationEventsImpl) QueryInterface(riid *syscall.GUID, ppvObject unsafe.Pointer) win32.HRESULT {
	if *riid == IID_ApplicationEvents {
...
func (this *ApplicationEventsImpl) Invoke(dispIdMember int32, riid *syscall.GUID, lcid uint32,
...
type ApplicationEventsComObj struct {
	ole.IDispatchComObj
}

func NewApplicationEventsComObj(dispImpl ApplicationEventsDispInterface, scoped bool) *ApplicationEventsComObj {
	comObj := com.NewComObj[ApplicationEventsComObj](
		&ApplicationEventsImpl {DispImpl: dispImpl})
	if scoped {
