...
func IndexesFromVar(v ole.Variant) *Indexes {
	return NewIndexes(v.IDispatch(), false, false)
}
...
func (this *Indexes) Item(index int32) *Index {
	...
	return NewIndex(retVal.IDispatch(), false, true)
}
...
func (this *Indexes) AutoMarkEntries(concordanceFileName string)  {
	retVal, _ := this.Call(0x00000067, []interface{}{concordanceFileName})
	_= retVal
}
...
func (this *Indexes) Add(range_ *Range, optArgs ...interface{}) *Index {
	...
	retVal, _ := this.Call(0x00000068, []interface{}{range_}, optArgs...)
	return NewIndex(retVal.IDispatch(), false, true)
}
