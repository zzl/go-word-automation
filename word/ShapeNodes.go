...
var IID_ShapeNodes = syscall.GUID{0x000209CE, 0x0000, 0x0000, 
...
func (this *ShapeNodes) Application() *Application {
...
func (this *ShapeNodes) Item(index *ole.Variant) *ShapeNode {
