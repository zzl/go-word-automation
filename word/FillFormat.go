...
var IID_FillFormat = syscall.GUID{0x000209C8, 0x0000, 0x0000, 
...
func FillFormatFromVar(v ole.Variant) *FillFormat {
	return NewFillFormat(v.PdispValVal(), false, false)
}
...
func (this *FillFormat) Application() *Application {
...
func (this *FillFormat) OneColorGradient(style int32, variant int32, degree float32)  {
	retVal := this.Call(0x0000000b, []interface{}{style, variant, degree})
	_= retVal
}

func (this *FillFormat) Patterned(pattern int32)  {
	retVal := this.Call(0x0000000c, []interface{}{pattern})
	_= retVal
}

func (this *FillFormat) PresetGradient(style int32, variant int32, presetGradientType int32)  {
	retVal := this.Call(0x0000000d, []interface{}{style, variant, presetGradientType})
	_= retVal
}

func (this *FillFormat) PresetTextured(presetTexture int32)  {
	retVal := this.Call(0x0000000e, []interface{}{presetTexture})
	_= retVal
}
...
func (this *FillFormat) TwoColorGradient(style int32, variant int32)  {
	retVal := this.Call(0x00000010, []interface{}{style, variant})
	_= retVal
}

func (this *FillFormat) UserPicture(pictureFile string)  {
	retVal := this.Call(0x00000011, []interface{}{pictureFile})
	_= retVal
}

func (this *FillFormat) UserTextured(textureFile string)  {
	retVal := this.Call(0x00000012, []interface{}{textureFile})
	_= retVal
}
